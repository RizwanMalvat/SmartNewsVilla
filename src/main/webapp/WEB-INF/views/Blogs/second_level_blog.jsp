...
<jsp:include page="../Template/Header.jsp"></jsp:include>
    <div id="page-wrapper">
        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <li class="active">
                    <i class="fa fa-edit"></i> Second Level Blog
                </li>
            </ol>
        </div>
    </div>
    ...
    <div class="container-fluid">
        ...
        <div class="row">
            ...
            <form role="form"id="form-validation-simple" action="<%= request.getContextPath()%>/BlogsController/secondlevelmenu/addblog/<%= menuid%>" name="form-validation-simple" method="POST" enctype="multipart/form-data">
                <div class="col-lg-12"> 
                    <div class="col-lg-6"> 
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-8">
                                <input class="form-control" name="blogname" placeholder="Enter blog title">
                            </div>
                        </div>
