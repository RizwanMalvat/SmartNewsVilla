...
<jsp:include page="../Template/Header.jsp"></jsp:include>
    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <form role="form"id="form-validation-simple" action="<%= request.getContextPath()%>/Menus/firstlevelmenu/addmenu" name="form-validation-simple" method="POST">
                <div class="col-lg-6"> 
                    <div class="form-group">
                        <div class="col-lg-4">
                            <label>First level menu name</label>
                        </div>
                        <div class="col-lg-8">
                            <input class="form-control" name="menuname" placeholder="Enter first level menu name">
                        </div>
                    </div>
                </div>
                <div class="col-lg-6">
                    <div class="form-group">
                        <div class="col-lg-4">
                            <label>First level menu path</label>
                        </div>
                        <div class="col-lg-8">
                            <input class="form-control" name="menupath" placeholder="Enter first level menu path">
                        </div>
                    </div>
                </div>
