...
<jsp:include page="../Template/Header.jsp"></jsp:include>
    <div id="page-wrapper">
        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <li class="active">
                    <i class="fa fa-edit"></i> Third level menu
                </li>
            </ol>
        </div>
    </div>
    ...
    <div class="container-fluid">
        ...
        <div class="row">
            ...
            <form role="form"id="form-validation-simple" action="<%= request.getContextPath()%>/Menus/thirdlevelmenu/addmenu/<%= parentmenuid %>" name="form-validation-simple" method="POST">
                <div class="col-lg-6"> 
                    <div class="form-group">
                        <div class="col-lg-4">
                            <label>Third level menu name</label>
                        </div>
                        <div class="col-lg-8">
                            <input class="form-control" name="menuname" placeholder="Enter third level menu name">
                        </div>
                    </div>
                </div>
                <div class="col-lg-6">
                    <div class="form-group">
                        <div class="col-lg-4">
                            <label>Third level menu path</label>
                        </div>
                        <div class="col-lg-8">
                            <input class="form-control" name="menupath" placeholder="Enter third level menu path">
                        </div>
                    </div>
                </div>
        ...
        <div class="row"><br/><br/><hr/><br/>
            ...
            <table id="first_level_menu" class="display" cellspacing="0" width="100%">
                <thead>
                    <tr>
                        <th>Menu Name</th>
                        <th>Menu Path</th>
                ...
                <tbody>
                    ...
                    <%  CheckInput checkInput = new CheckInput();
                        if (request.getAttribute("firstlevelmenu") != null) {
                            List<FirstLevelMenu> firstlevelmenus = (List<FirstLevelMenu>) request.getAttribute("firstlevelmenu");
                    ...
                    <tr>
                        ...
                        <td><%= checkInput.checkValue(firstlevelmenu.getMenuname())%></td>
                        <td>
                            <a class="btn btn-default" href="<%=request.getContextPath()%>/BlogsController/thirdmenu/<%=firstlevelmenu.getFirstmenuid()%>">  Add Blog</a>
                        </td>
                    </tr>
                    <%
                                }
